...
final public class PhysicalFile2 {
    public long creationTime;
    public int divisor = 80;
    //RandomAccessFile ra = null; //use "close()" method instead!
    ...
    public PhysicalFile2(FileInputStream fis, DataBuffers dataBuffers, int lookupVersion, int lookupMinorVersion) throws Exception {
