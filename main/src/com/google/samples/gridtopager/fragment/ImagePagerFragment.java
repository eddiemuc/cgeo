...
//    viewPager.listener.setListe.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
//      @Override
    ...
    setEnterSharedElementCallback(
        new SharedElementCallback() {
          ...
          public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            ...
            Fragment currentFragment = (Fragment) ((FragmentStateAdapter)viewPager.getAdapter())
                    .createFragment(MainActivity.currentPosition);
...
//              final View view = ((ImagePagerAdapter) viewPager.getAdapter()).getViewFor(MainActivity.currentPosition);
//              if (view != null) {
