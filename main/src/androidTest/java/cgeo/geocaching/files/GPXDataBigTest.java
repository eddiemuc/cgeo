...
//        return readVersionedGPX(parser, resourceIds);
    ...
    private List<Geocache> readGPX(@RawRes final int... resourceIds) throws IOException, ParserException {
        ...
        for (final int resourceId : resourceIds) {
            ...
            try {
                final GPXData gpxData = GPXData.parse("test", instream);
                final Collection<Geocache> caches = gpxData.getGeocaches();
